...
import { Sparkles, MessageSquare, ArrowUp, Filter, Eye, ChevronRight, User, Globe, WifiOff, Send, MapPin, Navigation } from 'lucide-react';
          ...
          <div className="bg-white border border-slate-200 w-full md:max-w-xl rounded-t-3xl md:rounded-2xl shadow-2xl p-5 space-y-4 max-h-[90vh] overflow-y-auto flex flex-col animate-in slide-in-from-bottom">
            ...
            <div className="space-y-3.5 overflow-y-auto pr-1 flex-1">
              ...
              {selectedReport.photo_url && (
                <div 
                  className="rounded-xl overflow-hidden border border-slate-100 max-h-56 relative group cursor-zoom-in shadow-xs transition-all duration-300 hover:shadow-md"
                  onClick={() => setLightboxImg(selectedReport.photo_url || null)}
                >
                  <img src={selectedReport.photo_url} alt="Attached" className="w-full h-full object-cover group-hover:scale-[1.02] transition-transform duration-300" />
